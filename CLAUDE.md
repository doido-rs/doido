...
| [docs/15-storage.md](docs/15-storage.md) | `doido-storage` | Attached-file storage: blobs, polymorphic attachments, pluggable services (disk/memory/S3/R2/Azure), Active Storage analogue |
...
- [x] 15-storage — **Pluggable `Service` (disk default/memory/S3/R2/Azure), blobs+polymorphic attachments (raw SQL), HMAC signed ids/URLs, axum redirect+proxy+direct-upload serving, `storage:install` generator; variants/previews deferred**
