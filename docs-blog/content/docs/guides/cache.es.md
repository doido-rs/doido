...
las [sesiones](@/docs/guides/middleware.es.md), el rate limiting y la
[caché de fragmentos](@/docs/guides/views.es.md).
...
- [Middleware y sesiones](@/docs/guides/middleware.es.md) — `CacheSessionStore` y rate limiting.
- [Vistas](@/docs/guides/views.es.md) — caché de fragmentos vía `cache_fragment`.
- [Jobs](@/docs/guides/jobs.es.md) — los backends Redis/DB son infraestructura compartida.
