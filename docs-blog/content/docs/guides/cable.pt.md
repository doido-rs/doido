...
- [Middleware & sessões](@/docs/guides/middleware.pt.md) — autenticando o upgrade do WebSocket.
- [Cache](@/docs/guides/cache.pt.md) — o backend Redis é compartilhado com o pub/sub.
- [Geradores & CLI](@/docs/guides/generators.pt.md) — `doido generate channel`.
