...
- [Mailer](@/docs/guides/mailer.es.md) — `deliver_later` encola en la cola `mailers`.
- [Cache](@/docs/guides/cache.es.md) y [Modelos](@/docs/guides/models.es.md) — backends Redis/DB.
- [Generadores y CLI](@/docs/guides/generators.es.md) — `doido generate job` y `doido worker`.
