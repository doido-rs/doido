...
[Core](@/docs/guides/core.es.md)); `MiddlewareConfig`/`CorsConfig` están desactivados a
...
- [Core](@/docs/guides/core.es.md) — la sección `logger` y el `Environment`.
- [Middleware y sesiones](@/docs/guides/middleware.es.md) — la sección `middleware.cors`.
- [Modelos](@/docs/guides/models.es.md) — la sección `database` y el pool de conexiones.
