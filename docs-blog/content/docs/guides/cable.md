...
- [Middleware & sessions](@/docs/guides/middleware.md) — authenticating the WebSocket upgrade.
- [Cache](@/docs/guides/cache.md) — the Redis backend is shared with pub/sub.
- [Generators & CLI](@/docs/guides/generators.md) — `doido generate channel`.
