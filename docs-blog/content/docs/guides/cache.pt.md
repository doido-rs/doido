...
[sessões](@/docs/guides/middleware.pt.md), rate limiting e o
[cache de fragmento](@/docs/guides/views.pt.md).
...
- [Middleware & sessões](@/docs/guides/middleware.pt.md) — `CacheSessionStore` e rate limiting.
- [Views](@/docs/guides/views.pt.md) — cache de fragmento via `cache_fragment`.
- [Jobs](@/docs/guides/jobs.pt.md) — os backends Redis/DB são infraestrutura compartilhada.
