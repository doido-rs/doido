...
- [Middleware y sesiones](@/docs/guides/middleware.es.md) — autenticar el upgrade del WebSocket.
- [Cache](@/docs/guides/cache.es.md) — el backend Redis se comparte con el pub/sub.
- [Generadores y CLI](@/docs/guides/generators.es.md) — `doido generate channel`.
