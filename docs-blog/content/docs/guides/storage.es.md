...
[doido-jobs](@/docs/guides/jobs.es.md) en vez de bloquear la petición.
...
- [Modelos](@/docs/guides/models.es.md) — los attachments referencian tus registros; `ensure_tables`.
- [Jobs](@/docs/guides/jobs.es.md) — `purge_later` y limpieza en segundo plano.
- [Generadores y CLI](@/docs/guides/generators.es.md) — `doido generate storage:install` / `storage:adapter`.
