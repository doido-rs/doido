...
> de comandos, veja [CLI & geradores](@/docs/cli.pt.md).
...
chamando `doido_generators::run(Some(routes))`.
...
- [Models](@/docs/guides/models.pt.md) — o que `generate model`/`migration` produzem.
- [Controllers & roteamento](@/docs/guides/controllers.pt.md) — o bloco `routes!` que os geradores editam.
- [Jobs](@/docs/guides/jobs.pt.md), [Mailer](@/docs/guides/mailer.pt.md), [Cable](@/docs/guides/cable.pt.md) — seus geradores.
