...
- [Middleware & sessions](@/docs/guides/middleware.md) — the Tower stack, sessions, flash, CSRF, CORS.
- [Views](@/docs/guides/views.md) — what `ctx.render(...)` delegates to.
- [Models](@/docs/guides/models.md) — using `ctx.db()` inside actions.
