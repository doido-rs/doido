...
- [Configuration](@/docs/guides/configuration.md) — where `logger` and other settings come from.
- [Models](@/docs/guides/models.md) — `sql` logging flows into sea-orm query logs.
- [Generators & CLI](@/docs/guides/generators.md) — consumers of the inflector.
