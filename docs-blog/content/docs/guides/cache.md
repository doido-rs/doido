...
[sessions](@/docs/guides/middleware.md), rate limiting, and [fragment caching](@/docs/guides/views.md).
...
- [Middleware & sessions](@/docs/guides/middleware.md) — `CacheSessionStore` and rate limiting.
- [Views](@/docs/guides/views.md) — fragment caching via `cache_fragment`.
- [Jobs](@/docs/guides/jobs.md) — the Redis/DB backends are shared infrastructure.
