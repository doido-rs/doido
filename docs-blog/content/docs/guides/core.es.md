...
- [Configuración](@/docs/guides/configuration.es.md) — de dónde vienen `logger` y otros ajustes.
- [Modelos](@/docs/guides/models.es.md) — el logging de `sql` fluye hacia los logs de query de sea-orm.
- [Generadores y CLI](@/docs/guides/generators.es.md) — consumidores del inflector.
