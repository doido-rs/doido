...
> table see [CLI & generators](@/docs/cli.md).
...
- [Models](@/docs/guides/models.md) — what `generate model`/`migration` produce.
- [Controllers & routing](@/docs/guides/controllers.md) — the `routes!` block generators edit.
- [Jobs](@/docs/guides/jobs.md), [Mailer](@/docs/guides/mailer.md), [Cable](@/docs/guides/cable.md) — their generators.
