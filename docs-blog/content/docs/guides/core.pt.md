...
- [Configuração](@/docs/guides/configuration.pt.md) — de onde vêm `logger` e outras configurações.
- [Models](@/docs/guides/models.pt.md) — o logging de `sql` flui para os logs de query do sea-orm.
- [Geradores & CLI](@/docs/guides/generators.pt.md) — consumidores do inflector.
