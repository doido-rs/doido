...
renderizan mediante el mismo [engine Tera](@/docs/guides/views.es.md) que las vistas.
...
correo en la cola `mailers` para que un [worker](@/docs/guides/jobs.es.md) lo envíe.
...
- [Jobs](@/docs/guides/jobs.es.md) — la cola `mailers` y el worker detrás de `deliver_later`.
- [Vistas](@/docs/guides/views.es.md) — el engine que renderiza las plantillas de correo.
- [Generadores y CLI](@/docs/guides/generators.es.md) — `doido generate mailer`.
