...
pela mesma [engine Tera](@/docs/guides/views.pt.md) das views.
...
fila `mailers` para um [worker](@/docs/guides/jobs.pt.md) enviar.
...
- [Jobs](@/docs/guides/jobs.pt.md) — a fila `mailers` e o worker por trás do `deliver_later`.
- [Views](@/docs/guides/views.pt.md) — a engine que renderiza os templates de e-mail.
- [Geradores & CLI](@/docs/guides/generators.pt.md) — `doido generate mailer`.
