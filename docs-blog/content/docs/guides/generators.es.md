...
> tabla rápida de comandos, ve [CLI y generadores](@/docs/cli.es.md).
...
- [Modelos](@/docs/guides/models.es.md) — lo que producen `generate model`/`migration`.
- [Controladores y enrutamiento](@/docs/guides/controllers.es.md) — el bloque `routes!` que editan los generadores.
- [Jobs](@/docs/guides/jobs.es.md), [Mailer](@/docs/guides/mailer.es.md), [Cable](@/docs/guides/cable.es.md) — sus generadores.
