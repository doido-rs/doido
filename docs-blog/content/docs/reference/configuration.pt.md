...
- [Core](@/docs/reference/core.pt.md) — a seção `logger` e o `Environment`.
- [Middleware & sessões](@/docs/reference/middleware.pt.md) — a seção `middleware.cors`.
- [Models](@/docs/reference/models.pt.md) — a seção `database` e o pool de conexões.
